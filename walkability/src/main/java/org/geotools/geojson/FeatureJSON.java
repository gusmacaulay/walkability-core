...
/**
 * Reads and writes feature objects to and from geojson. <p>
 * <pre>
...
public class FeatureJSON {
    ...
    /**
     * Sets the target feature type for parsing. <p> Setting the target feature
     * type will help the geojson parser determine the type of feature
     * properties during properties. When the type is not around all properties
     * are returned as a string. </p>
     *
     * @param featureType The feature type. Parsed features will reference this
     * feature type.
     */
    ...
    /**
     * The flag controlling whether feature bounds are encoded. <p> When set
     * each feature object will contain a "bbox" attribute whose value is an
     * array containing the elements of the bounding box (in x1,y1,x2,y2 order)
     * of the feature </p>
     */
    ...
    /**
     * The flag controlling whether feature collection bounds are encoded. <p>
     * When set the feature collection object will contain a "bbox" attribute
     * whose value is an array containing elements of the bounding box (in
     * x1,y1,x2,y2 order) of the feature collection. </p>
     */
    ...
    /**
     * Sets the flag controlling whether feature coordinate reference systems
     * are encoded.
     *
    ...
    /**
     * The flag controlling whether feature coordinate reference systems are
     * encoded. <p> When set each feature object will contain a "crs" attribute
     * describing the coordinate reference system of the feature. </p>
     *
     */
    ...
    /**
     * Sets the flag controlling whether feature collection coordinate reference
     * systems are encoded.
     *
     ...
     * systems are encoded. <p> When set the feature collection object will
     * contain a "crs" attribute describing the coordinate reference system of
     * the feature collection. </p>
     */
    ...
    /**
     * Writes a feature as GeoJSON. <p> This method calls through to {@link #writeFeature(FeatureCollection, Object)}
     * </p>
     *
     * @param feature The feature.
     ...
     *
     * @param input The input. See {@link GeoJSONUtil#toReader(Object)} for
     * details.
     * @return The feature.
     *
     * @throws IOException In the event of a parsing error or if the input json
     * is invalid.
     */
    public SimpleFeature readFeature(Object input) throws IOException {
        return GeoJSONUtil.parse(new FeatureHandler(new SimpleFeatureBuilder(featureType), attio), input, false);
    }

    /**
     * Reads a feature from GeoJSON. <p> This method calls through to {@link #readFeature(Object)}
     * </p>
     *
    ...
    /**
     * Writes a feature collection as GeoJSON. <p> This method calls through to {@link #writeFeatureCollection(FeatureCollection, Object)}
     * </p>
     *
     * @param features The feature collection.
    ...
    /**
     * Reads a feature collection from GeoJSON. <p> Warning that this method
     * will load the entire feature collection into memory. For large feature
     * collections {@link #streamFeatureCollection(Object)} should be used. </p>
     *
     * @param input The input. See {@link GeoJSONUtil#toReader(Object)} for
     * details.
    ...
    /**
     * Reads a feature collection from GeoJSON streaming back the contents via
     * an iterator.
     *
     * @param input The input. See {@link GeoJSONUtil#toReader(Object)} for
     * details.
    ...
    /**
     * Writes a coordinate reference system as GeoJSON. <p> This method calls
     * through to {@link #writeCRS(CoordinateReferenceSystem, Object)} </p>
     *
     * @param crs The coordinate reference system.
     * @param output The output stream.
     */
    ...
    /**
     * Reads a coordinate reference system from GeoJSON. <p> This method only
     * handles named coordinate reference system objects. </p>
     *
     * @param input The input. See {@link GeoJSONUtil#toReader(Object)} for
     * details.
    ...
    /**
     * Reads a coordinate reference system from GeoJSON. <p> This method only
     * handles named coordinate reference system objects. </p> <p> This method
     * calls through to {@link #readCRS(Object)} </p>
     *
     * @param input The input. See {@link GeoJSONUtil#toReader(Object)} for
     * details.
     * @return The coordinate reference system.
    ...
    /**
     * Writes a coordinate reference system as GeoJSON returning the result as a
     * string.
     *
     * @param crs The coordinate reference system.
     *
